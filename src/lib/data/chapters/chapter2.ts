...
- UU (Unconsolidated Undrained): đo cu — cho bài toán ngắn hạn`, sourceRef: src },
  ...
  formulas: [
    { id: 'f2-1', chapterId: 'ch2', name: 'Hệ số nén lún', expression: 'a = (e₁ - e₂)/(p₂ - p₁)', variables: [{ symbol: 'a', name: 'Hệ số nén lún', unit: 'kPa⁻¹' }], meaning: 'Mức độ giảm e khi tăng p', usageContext: 'Tính mô đun biến dạng', sourceRefs: [src] },
    { id: 'f2-2', chapterId: 'ch2', name: 'Mô đun biến dạng', expression: 'Eoed = (1+e₁)/a', variables: [{ symbol: 'Eoed', name: 'Mô đun BD', unit: 'kPa' }], meaning: 'Độ cứng nén 1 trục', usageContext: 'Tính lún bằng PP cộng lớp', sourceRefs: [src] },
    { id: 'f2-3', chapterId: 'ch2', name: 'Định luật Darcy', expression: 'v = k × i', variables: [{ symbol: 'v', name: 'Vận tốc thấm', unit: 'm/s' }, { symbol: 'k', name: 'Hệ số thấm', unit: 'm/s' }, { symbol: 'i', name: 'Gradient thủy lực' }], meaning: 'Vận tốc thấm tỷ lệ gradient', usageContext: 'Tính lưu lượng thấm, cố kết', sourceRefs: [src] },
    { id: 'f2-4', chapterId: 'ch2', name: 'Mohr-Coulomb', expression: 'τ = σ × tan(φ) + c', latex: '\\tau = \\sigma \\tan\\varphi + c', variables: [{ symbol: 'τ', name: 'Sức chống cắt', unit: 'kPa' }, { symbol: 'σ', name: 'Ứng suất pháp', unit: 'kPa' }, { symbol: 'φ', name: 'Góc ma sát trong', unit: '°' }, { symbol: 'c', name: 'Lực dính', unit: 'kPa' }], meaning: 'Tiêu chuẩn phá hoại cắt', usageContext: 'SCT, ổn định mái', sourceRefs: [src] },
    { id: 'f2-5', chapterId: 'ch2', name: 'Chỉ số nén Cc', expression: 'Cc = Δe / Δlgp', variables: [{ symbol: 'Cc', name: 'Chỉ số nén' }], meaning: 'Độ dốc đường NCL trên e-lgp', usageContext: 'Tính lún đất NC', sourceRefs: [src] },
    { id: 'f2-6', chapterId: 'ch2', name: 'Hệ số rỗng theo biến dạng', expression: 'eᵢ = e₀ - (1+e₀)×ΔHᵢ/H₀', variables: [{ symbol: 'eᵢ', name: 'Hệ số rỗng cấp i' }, { symbol: 'ΔHᵢ', name: 'Biến dạng tổng', unit: 'mm' }, { symbol: 'H₀', name: 'Chiều cao ban đầu', unit: 'mm' }], meaning: 'Tính e từ biến dạng đo', usageContext: 'TN nén cố kết', sourceRefs: [src] },
  ],
