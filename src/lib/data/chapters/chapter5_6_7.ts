...
σa = Ka×(γ×z + q) - 2c×√Ka`, sourceRef: s6 },
  ...
  quizzes: [
    ...
    { id: 'q6-7', chapterId: 'ch6', type: 'multiple-choice', difficulty: 'vận dụng', question: 'Tính chiều sâu vùng kéo zc khi c=10kPa, γ=18, φ=30°', options: ['1.92m', '0.96m', '2.5m'], correctAnswer: '1.92m', explanation: 'Ka=1/3. zc = 2c/(γ√Ka) = 2×10 / (18×√(1/3)) = 20 / 10.39 ≈ 1.92m', sourceRefs: [s6] },
...
**Biện pháp gia cố:** Giảm dốc (thoải mái), bệ phản áp, neo đất, cọc, rãnh thoát nước.`, sourceRef: s7 },
  ...
  quizzes: [
    ...
    { id: 'q7-8', chapterId: 'ch7', type: 'multiple-choice', difficulty: 'nhận biết', question: 'Chữ số Nᵢ trong công thức Fellenius được tính bằng?', options: ['Wᵢ × sinαᵢ', 'Wᵢ × cosαᵢ', 'Wᵢ × tanαᵢ'], correctAnswer: 'Wᵢ × cosαᵢ', explanation: 'Nᵢ là thành phần lực pháp tuyến trên mặt trượt = Wᵢcosαᵢ.', sourceRefs: [s7] },
  ],
