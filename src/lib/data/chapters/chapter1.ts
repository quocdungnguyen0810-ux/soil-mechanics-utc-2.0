...
Kết cấu ảnh hưởng lớn đến tính thấm, tính nén lún, sức chống cắt. Đất nguyên dạng (undisturbed) giữ kết cấu tự nhiên; đất phá hủy kết cấu (remolded) mất liên kết, sức chống cắt giảm đáng kể.`,
  ...
  formulas: [
    ...
    { id: 'f1-2', chapterId: 'ch1', name: 'Trọng lượng riêng hạt', expression: 'γs = Gs/Vs', latex: '\\gamma_s = \\frac{G_s}{V_s}', variables: [{ symbol: 'γs', name: 'TL riêng hạt', unit: 'kN/m³' }, { symbol: 'Gs', name: 'TL phần rắn', unit: 'kN' }], meaning: 'Đặc trưng cho thành phần khoáng vật', usageContext: 'Tính tỷ trọng, hệ số rỗng', sourceRefs: [src] },
    { id: 'f1-3', chapterId: 'ch1', name: 'Tỷ trọng hạt', expression: 'Δ = γs / γn', latex: '\\Delta = \\frac{\\gamma_s}{\\gamma_n}', variables: [{ symbol: 'Δ', name: 'Tỷ trọng hạt' }, { symbol: 'γn', name: 'TL riêng nước', unit: '10 kN/m³' }], meaning: 'Tỷ số TL riêng hạt / TL riêng nước', usageContext: 'Xác định bằng TN bình tỷ trọng', sourceRefs: [src] },
    ...
    { id: 'f1-7', chapterId: 'ch1', name: 'Độ rỗng', expression: 'n = Vr/V = e/(1+e)', latex: 'n = \\frac{V_r}{V} = \\frac{e}{1+e}', variables: [{ symbol: 'n', name: 'Độ rỗng', unit: '%' }], meaning: 'Tỷ lệ lỗ rỗng/tổng thể tích (luôn < 1)', usageContext: 'Ước tính lượng nước bão hòa', sourceRefs: [src] },
    { id: 'f1-8', chapterId: 'ch1', name: 'Độ bão hòa', expression: 'Sr = Vn/Vr = W×Δ/e', latex: 'S_r = \\frac{V_n}{V_r} = \\frac{W \\cdot \\Delta}{e}', variables: [{ symbol: 'Sr', name: 'Độ bão hòa' }], meaning: 'Sr=0: khô, Sr=1: bão hòa', usageContext: 'Đánh giá mức bão hòa, phân loại', sourceRefs: [src] },
    ...
    { id: 'f1-10', chapterId: 'ch1', name: 'Chỉ số dẻo', expression: 'IP = WL - WP', latex: 'I_P = W_L - W_P', variables: [{ symbol: 'IP', name: 'Chỉ số dẻo', unit: '%' }, { symbol: 'WL', name: 'Giới hạn chảy', unit: '%' }, { symbol: 'WP', name: 'Giới hạn dẻo', unit: '%' }], meaning: 'Phạm vi trạng thái dẻo', usageContext: 'Phân loại: á cát (1-7), á sét (7-17), sét (>17)', sourceRefs: [src] },
    { id: 'f1-11', chapterId: 'ch1', name: 'Độ sệt', expression: 'IL = (W - WP) / IP', latex: 'I_L = \\frac{W - W_P}{I_P}', variables: [{ symbol: 'IL', name: 'Độ sệt' }, { symbol: 'W', name: 'Độ ẩm TN', unit: '%' }], meaning: 'Trạng thái đất dính hiện tại', usageContext: 'Cứng (IL<0) → chảy (IL≥1)', sourceRefs: [src] },
    { id: 'f1-12', chapterId: 'ch1', name: 'Công thức tổng hợp γ', expression: 'γ = (1+W)×Δ×γn/(1+e)', latex: '\\gamma = \\frac{(1+W) \\cdot \\Delta \\cdot \\gamma_n}{1+e}', variables: [{ symbol: 'γ', name: 'TL thể tích', unit: 'kN/m³' }], meaning: 'Tính γ khi biết W, Δ, e', usageContext: 'Bài tập tính chỉ tiêu vật lý', sourceRefs: [src] },
  ],
